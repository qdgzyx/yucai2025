...
<div class="container">
    <h2>新建班级小组</h2>
    <form method="POST" action="{{ route('group-basic-infos.store') }}">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="leader" name="leader" required maxlength="20">
        </div>

        <div class="mb-3">
            <label for="members" class="form-label">组员名单</label>
            <textarea class="form-control" id="members" name="members" rows="3" required></textarea>
